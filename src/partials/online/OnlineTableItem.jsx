...
export default function OnlineTableItem(props) {
    ...
    return (
        <div className="grid grid-cols-7 py-4 border border-customBrown rounded-lg my-1 bg-customBg font-semibold cursor-pointer">
            ...
            <div className="flex justify-center items-center">
                <Tooltip content={props.faction.includes('horde') ? 'Horde' : 'Alliance'} color="primary" showArrow={true}>
