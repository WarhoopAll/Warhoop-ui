        ...
        <>
                ...
                <div className="grow">
                    ...
                    {loading ? (
                            ...
                            >
                                ...
                                <div className="grow">
                                    ...
                                    <div className="flex flex-wrap text-sm ">
                                        <div className="flex items-center after:content-['·'] after:text-slate-400 after:px-2">
                        ...
                        !loading && (
                            <div className="no-news text-customTXT">
                                <h2>{t("NoNews")}</h2>
                ...
                {totalPage > 1 && (
                    <div className="duration-500 ease-in-out opacity-0 animate-fadeIn">
