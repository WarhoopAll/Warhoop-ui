            ...
            if (response.ok) {
                if (responseData.data === null) {
                    ...
                    if (reactionType === 1) {
                        ...
                        setHasDisliked(true);
                        showToast("Disliked successfully!", "info");
                    }
                }
            } else {
                showToast(responseData.message || "Failed to send reaction.", "error");
            }
        } catch (error) {
            showToast("Error sending reaction. Please try again.", "error");
